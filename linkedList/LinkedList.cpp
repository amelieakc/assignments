...
bool LinkedList<ItemType>::insert(int newPosition, const ItemType& newEntry)
{
  ...
  if (ableToInsert)
    {
      // Create a new node contalning the new entry 
      ...
      else
	{
	  ...
	  currNode->getPrev()->setNext(newNodePtr);
	  newNodePtr->setPrev(currNode->getPrev());
	  newNodePtr->setNext(currNode);
	  currNode->setPrev(newNodePtr);
	}
...
bool LinkedList<ItemType>::remove(int position)
{
  ...
  if (ableToRemove)
      ...
      else
	{
	  ...
	  Node<ItemType>* nodeToDel = getNodeAt(position);
